...
typeorm_1.createConnection().then(function (connection) {
    ...
    app.get("/", function (req, res) { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    articles = _a.sent();
                    return [4 /*yield*/, pinnedRepository.find({ where: { user_id: 1 }, relations: ["article_id"] })];
                case 2:
                    pinned = _a.sent();
    ...
    app.post("/filter", function (req, res) { return __awaiter(_this, void 0, void 0, function () {
        var post, data, data;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                ...
                case 1:
                    data = _a.sent();
                    return [3 /*break*/, 4];
                case 2: return [4 /*yield*/, articlesRepository.find()];
                case 3:
                    data = _a.sent();
                    _a.label = 4;
                case 4:
